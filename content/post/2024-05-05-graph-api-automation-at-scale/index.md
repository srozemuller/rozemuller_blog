...
images:
- images/post/graph-api-automation-at-scale/image.png
categories:
    - Graph API
    - Automation
tags:
...
But, also the Graph API has its limits. When requesting the Graph API at scale you have seen a 429 response for sure.

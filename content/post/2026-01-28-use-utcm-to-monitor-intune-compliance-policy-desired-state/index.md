...
[Creating the service principal and assigning permissions can be done through Azure AD portal or Graph API.](https://learn.microsoft.com/en-us/graph/utcm-authentication-setup#authentication)
